                    ...
                    child: Column(
                     crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        ...
                        Text('''A type of athletic shoe meant for competitive, high-impact cheerleading activity, often with switchable color accents to match team colors, and finger notches in the soles for use in acrobatics.''',style: TextStyle(color: Colors.black54),),
