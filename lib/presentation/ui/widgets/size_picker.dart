...
class _SizePickerState extends State<SizePicker> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        const Text("Size",style: TextStyle(color: Colors.black87,fontSize: 18,fontWeight: FontWeight.w600),),
          ...
          children: widget.sizes.map((item){
            return GestureDetector(
              ...
              child: Container(
                ...
                child: Text(item,style: TextStyle(color: _selectedSize==item?Colors.white:null,fontSize: 18),),
              )
            );
          }).toList(),
        )
